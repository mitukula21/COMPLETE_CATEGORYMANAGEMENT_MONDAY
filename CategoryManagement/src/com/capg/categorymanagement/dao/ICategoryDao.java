...
public class ICategoryDao implements IcategoryDaoImpl {
	...
	//------------------------ 1. Category Management Application --------------------------
	/*******************************************************************************************************
	 - Function Name	:	deleteCategory(String deleteName) 
	 - Input Parameters	:	String deleteName
	 - Return Type		:	boolean
	 - Throws			:  	CategoryManagementException
	 - Author			:	CAPGEMINI
	 - Creation Date	:	24/06/2019
	...
	//------------------------ 1. Category Management Application --------------------------
	/*******************************************************************************************************
	 - Function Name	:	adminEmail(Category category) 
	 - Input Parameters	:	Category category
	 - Return Type		:	boolean
	 - Throws			:  	CategoryManagementException
	 - Author			:	CAPGEMINI
	 - Creation Date	:	24/06/2019
	 - Description		:	To check whether the inserted admin email exists in the database or not.
	 ********************************************************************************************************/
	...
	//------------------------ 1. Category Management Application --------------------------
	/*******************************************************************************************************
	 - Function Name	:	adminPassword(Category category) 
	 - Input Parameters	:	Category category
	 - Return Type		:	boolean
	 - Throws			:  	CategoryManagementException
	 - Author			:	CAPGEMINI
	 - Creation Date	:	24/06/2019
	 - Description		:	To check whether the inserted password exists in the database or not.
	 ********************************************************************************************************/
